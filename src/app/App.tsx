...
export function App() {
  ...
  const toolbarBtnClass = 'bg-blue-950 border border-blue-600 text-blue-300 rounded-md px-3 py-2 cursor-pointer text-sm flex items-center justify-center gap-1.5 whitespace-nowrap hover:bg-blue-900 transition-colors';
