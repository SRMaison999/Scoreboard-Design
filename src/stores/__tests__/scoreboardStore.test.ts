...
describe('scoreboardStore', () => {
  ...
  describe('templates', () => {
    ...
    it('loadState charge un etat complet', () => {
      const { resetState: _r, loadState: _l, ...currentState } = useScoreboardStore.getState();
      const plainState: ScoreboardState = {
        bodyType: currentState.bodyType,
        showPenalties: currentState.showPenalties,
        team1: 'USA',
        team2: 'CAN',
        ...
        clockBoxMode: currentState.clockBoxMode,
        periodOptions: currentState.periodOptions,
        demoRunning: currentState.demoRunning,
        titleCenter: currentState.titleCenter,
        titleLeft: currentState.titleLeft,
        titleRight: currentState.titleRight,
        fontTeams: currentState.fontTeams,
        fontClock: currentState.fontClock,
        fontBody: currentState.fontBody,
        colors: { ...currentState.colors },
        opacities: { ...currentState.opacities },
        showPlayerPhoto: currentState.showPlayerPhoto,
        playerStats: currentState.playerStats,
        stats: currentState.stats,
        penaltiesLeft: currentState.penaltiesLeft,
        penaltiesRight: currentState.penaltiesRight,
      };
