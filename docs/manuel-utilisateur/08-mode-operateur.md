...
Le mode opérateur est une interface simplifiée conçue pour le contrôle du scoreboard pendant un match. Il remplace le panneau éditeur par des contrôles grands format, tactiles et rapides.
