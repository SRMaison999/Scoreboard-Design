...
Le scoreboard propose 14 types d'affichage pour le corps du scoreboard. Le type est sélectionné dans le panneau **Modes** (1re icône du rail de navigation).

- **Type 1 : Layout libre** -- le mode principal et le plus flexible. Il fait l'objet d'un chapitre dédié : [03 - Layout libre](./03-layout-libre.md).
- **Types 2 à 14** -- types à agencement fixe, décrits ci-dessous.
...
|----|------|----------------|-----------|
| 1 | **[Layout libre](./03-layout-libre.md)** | Composition sur mesure | Avancé |
