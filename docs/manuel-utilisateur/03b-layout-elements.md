...
Guide détaillé de chaque type d'élément disponible dans la bibliothèque du Layout libre, avec instructions d'utilisation et astuces.
...
2. Cliquez dessus dans le canvas : ses propriétés s'affichent dans le panneau latéral
...
Affiche un tableau P1/P2/P3/OT avec les scores de chaque équipe par période.

L'élément lit les données de score par période configurées dans le panneau éditeur.
...
Affiche une ligne individuelle avec le nom, le numéro et la position d'un joueur.

**Options :**
- **Nom** : nom du joueur
- **Numéro** : numéro du maillot
- **Position** : poste du joueur
- **Afficher numéro / Afficher position** : cases à cocher pour contrôler la visibilité
- **Taille de police** et **Couleur du texte**

### Liste de joueurs

Affiche une liste complète de joueurs avec numéro, nom et position pour chacun.

**Options :**
- **Titre** : en-tête de la liste
- **Liste de joueurs** : chaque entrée contient numéro, nom et position
- **Afficher numéros / Afficher positions** : visibilité globale
- **Couleurs** : personnalisation des couleurs du titre et du texte

### Fiche joueur

Affiche une fiche joueur complète avec photo, nom, équipe et statistiques détaillées. Élément composite tout-en-un.
...
Affiche le nom et le numéro du buteur, avec photo optionnelle.

**Options :**
- **Nom** et **Numéro** du buteur
- **Photo** : optionnelle (référence à une photo importée)
- **Afficher numéro / Afficher photo** : cases à cocher
- **Taille de police** et **Couleur**

### Assistants

Affiche les noms et numéros des 1 ou 2 assistants sur un but.

**Options :**
- **Noms et numéros** des 2 assistants
- **Afficher numéros** : case à cocher
- **Taille de police** et **Couleur**

### Détails du but

Affiche le temps, la période et les décomptes du but (match et tournoi).

**Options :**
- **Temps** et **Période** du but
- **Décomptes** : numéro du but dans le match et dans le tournoi
- **Afficher période / Afficher décomptes** : cases à cocher
...
Affiche une ligne individuelle avec le rôle et le nom d'un membre du staff.

**Options :**
- **Rôle** : fonction (ex : "Entraîneur", "Assistant")
- **Nom** : nom de la personne
- **Taille de police** et **Couleur du texte**

### Liste du staff

Affiche la liste complète des membres du staff d'une équipe.

**Options :**
- **Titre** : en-tête de la liste
- **Liste de membres** : chaque entrée contient rôle + nom
- **Couleur du titre**, **Taille de police** et **Couleur du texte**

---

## Éléments de tableau et événement

### Tableau de données

Affiche un tableau configurable avec colonnes, lignes, en-têtes et surlignage. Idéal pour classements et statistiques tabulaires.

**Options :**
- **Titre** : en-tête du tableau
- **Colonnes** : label et alignement de chaque colonne
- **Lignes** : valeurs par colonne, avec option de surlignage par ligne
- **En-tête** : afficher ou masquer la ligne d'en-tête
- **Couleurs** : personnalisation complète

### Événement

Affiche un événement unique : but, pénalité, temps mort ou changement de période.

### Chronologie

Affiche la chronologie complète du match avec la liste de tous les événements triés par ordre chronologique.
...
Affiche un match unique avec date, heure, équipes, score et statut.

### Programme

Affiche un programme complet avec la liste des matchs à venir et terminés.
...
Affiche une image externe (URL ou fichier local). Utile pour incruster un logo, un sponsor ou un arrière-plan personnalisé.
...
**Exemple concret :** placez un Header complet en haut, un Classement au centre et une Fiche joueur en bas pour créer un écran de pause publicitaire complet. Consultez les [tutoriels](./03c-layout-tutoriels.md) pour des guides pas à pas.
...
- **Double-cliquez** sur le nom pour le renommer directement dans la liste
- Utilisez **Ctrl+Clic** pour ajouter/retirer un élément de la multi-sélection
...
Cliquez sur la quatrième icône du rail (**Presets**) pour accéder aux presets.

| Action | Description | Condition |
|--------|-------------|-----------|
| **Sauvegarder le champ** | Enregistre la configuration d'un seul élément (et ses éléments contenus) | Grisé si aucun champ sélectionné |
| **Sauvegarder l'écran** | Enregistre l'ensemble des éléments du canvas (positions, styles, données) | Grisé si le canvas est vide |
| **Charger un preset** | Applique un preset sauvegardé précédemment (mode Remplacer ou Ajouter) | - |
| **Exporter** | Télécharge le preset au format `.preset.json` | - |
