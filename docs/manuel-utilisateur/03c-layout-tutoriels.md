# Manuel utilisateur - Layout libre : Tutoriels pas à pas

5 tutoriels complets pour créer différents types de pages avec le Layout libre. Chaque tutoriel part d'un canvas vierge et détaille toutes les étapes jusqu'au résultat final.

> **Chapitre parent :** [Layout libre](03-layout-libre.md) | **Voir aussi :** [Éléments et presets](03b-layout-elements.md)

---

## Sommaire

- [Tutoriel 1 : Scoreboard classique avec header](#tutoriel-1--scoreboard-classique-avec-header)
- [Tutoriel 2 : Bande basse (lower third)](#tutoriel-2--bande-basse-lower-third)
- [Tutoriel 3 : Écran de statistiques comparatives](#tutoriel-3--écran-de-statistiques-comparatives)
- [Tutoriel 4 : Fiche joueur personnalisée](#tutoriel-4--fiche-joueur-personnalisée)
- [Tutoriel 5 : Écran multi-types (combinaison)](#tutoriel-5--écran-multi-types-combinaison)
