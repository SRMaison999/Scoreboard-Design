...
| [manuel-utilisateur/03-body-types.md](./manuel-utilisateur/03-body-types.md) | Les 14 types d'affichage (Type 1 : Layout libre, types 2-13, type 14 : Stats symétriques) |
